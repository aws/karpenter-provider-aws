...
| controller.image.tag | string | `"1.14.0"` | Tag of the controller image. |
...
| settings | object | `{"amiRefreshInterval":"1m","batchIdleDuration":"1s","batchMaxDuration":"10s","clusterCABundle":"","clusterEndpoint":"","clusterName":"","disableClusterStateObservability":false,"disableDryRun":false,"eksControlPlane":false,"enableZonalShift":false,"featureGates":{"capacityBuffer":false,"nodeOverlay":false,"nodeRepair":false,"reservedCapacity":true,"rolloutRestartDrainStrategy":false,"spotToSpotConsolidation":false,"staticCapacity":false},"ignoreDRARequests":true,"interruptionQueue":"","isolatedVPC":false,"minValuesPolicy":"Strict","preferencePolicy":"Respect","reservedENIs":"0","subnetRefreshInterval":"1m","vmMemoryOverheadPercent":0.075}` | Global Settings to configure Karpenter |
...
| settings.featureGates | object | `{"capacityBuffer":false,"nodeOverlay":false,"nodeRepair":false,"reservedCapacity":true,"rolloutRestartDrainStrategy":false,"spotToSpotConsolidation":false,"staticCapacity":false}` | Feature Gate configuration values. Feature Gates will follow the same graduation process and requirements as feature gates in Kubernetes. More information here https://kubernetes.io/docs/reference/command-line-tools-reference/feature-gates/#feature-gates-for-alpha-or-beta-features. |
...
| settings.featureGates.rolloutRestartDrainStrategy | bool | `false` | rolloutRestartDrainStrategy is ALPHA and is disabled by default. When enabled, draining a node that hosts a pod owned by a singleton (spec.replicas == 1) Deployment or StatefulSet triggers a `kubectl rollout restart`-style annotation patch on the owner instead of evicting the pod. |
