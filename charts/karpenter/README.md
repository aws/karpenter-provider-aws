...
| settings.featureGates.kubeletExpressions | bool | `false` | kubeletExpressions is ALPHA and is disabled by default. Setting this to true will allow CEL expressions in EC2NodeClass spec.kubelet maxPods, kubeReserved, and systemReserved. |
