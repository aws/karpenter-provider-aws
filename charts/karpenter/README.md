...
| controller.image.digest | string | `"sha256:80b2d0bf045ea5c02cc4abfc5f73cfea41dea772aa2e52c77bcadbaa27ed1ea0"` | SHA256 digest of the controller image. |
| controller.image.repository | string | `"public.ecr.aws/karpenter/controller"` | Repository path to the controller image. |
| controller.image.tag | string | `"1.0.9"` | Tag of the controller image. |
