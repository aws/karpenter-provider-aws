...
| controller.image.digest | string | `"sha256:ffe63af474c943153a607a43d5c435e80c46dfccdec79bd3af8e22e2d68cab76"` | SHA256 digest of the controller image. |
| controller.image.repository | string | `"public.ecr.aws/karpenter/controller"` | Repository path to the controller image. |
| controller.image.tag | string | `"1.7.3"` | Tag of the controller image. |
