...
| controller.image.digest | string | `"sha256:a96d673eebbf3c68c3f2130390243495f548b33b4e4d155545a814c9ed04c121"` | SHA256 digest of the controller image. |
| controller.image.repository | string | `"public.ecr.aws/karpenter/controller"` | Repository path to the controller image. |
| controller.image.tag | string | `"1.5.3"` | Tag of the controller image. |
