...
| controller.image.digest | string | `"sha256:b5a13b0afd8319b7a0b7d2ce2257a1a085beb6f4032c4ae656b480f75ef930f4"` | SHA256 digest of the controller image. |
| controller.image.repository | string | `"public.ecr.aws/karpenter/controller"` | Repository path to the controller image. |
| controller.image.tag | string | `"1.3.4"` | Tag of the controller image. |
