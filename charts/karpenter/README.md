...
| controller.image.digest | string | `"sha256:b4bbe91c9424983931f68fcb5e0a55f84f76747b96875ebe29109ddb6d6d1f0f"` | SHA256 digest of the controller image. |
| controller.image.repository | string | `"public.ecr.aws/karpenter/controller"` | Repository path to the controller image. |
| controller.image.tag | string | `"1.5.2"` | Tag of the controller image. |
