...
| controller.image.digest | string | `"sha256:b97f6f2fd65092ef47302df191438af4fd0f4e0f2eb247559629666e0d7679c1"` | SHA256 digest of the controller image. |
| controller.image.repository | string | `"public.ecr.aws/karpenter/controller"` | Repository path to the controller image. |
| controller.image.tag | string | `"1.0.11"` | Tag of the controller image. |
