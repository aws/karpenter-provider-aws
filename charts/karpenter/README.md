...
| settings | object | `{"amiRefreshInterval":"1m","awsFeatureGates":{"nodeClassCEL":false},"batchIdleDuration":"1s","batchMaxDuration":"10s","clusterCABundle":"","clusterEndpoint":"","clusterName":"","disableClusterStateObservability":false,"disableDryRun":false,"eksControlPlane":false,"enableZonalShift":false,"featureGates":{"capacityBuffer":false,"nodeOverlay":false,"nodeRepair":false,"reservedCapacity":true,"spotToSpotConsolidation":false,"staticCapacity":false},"ignoreDRARequests":true,"interruptionQueue":"","isolatedVPC":false,"minValuesPolicy":"Strict","nodeKubernetesVersion":"","preferencePolicy":"Respect","reservedENIs":"0","securityGroupRefreshInterval":"1m","subnetRefreshInterval":"1m","vmMemoryOverheadPercent":0.075}` | Global Settings to configure Karpenter |
...
| settings.nodeKubernetesVersion | string | `""` | Pins the Kubernetes version used when provisioning nodes, instead of tracking the discovered control plane version. This is useful for node version downgrades, e.g. to support EKS control plane version upgrade rollbacks. The discovered control plane version continues to be used for Karpenter's own compatibility checks. Expected format: major.minor (e.g. 1.30). Leave empty to track the control plane version. |
