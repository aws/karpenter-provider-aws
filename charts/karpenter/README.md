...
| controller.image.digest | string | `"sha256:bbdd68c4b0841987ef5fa5e2da40d63e61a76ade930297e21f380b3614c21078"` | SHA256 digest of the controller image. |
| controller.image.repository | string | `"public.ecr.aws/karpenter/controller"` | Repository path to the controller image. |
| controller.image.tag | string | `"1.5.1"` | Tag of the controller image. |
