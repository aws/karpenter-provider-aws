...
For full Karpenter documentation please checkout [https://karpenter.sh](https://karpenter.sh/v0.19.0/).

## Installing the Chart

You can follow the detailed installation instruction in the [documentation](https://karpenter.sh/v0.19.0/getting-started/getting-started-with-eksctl/#install) which covers the Karpenter prerequisites and installation options. The outcome of these instructions should result in something like the following command.
...
| controller.image | string | `"public.ecr.aws/karpenter/controller:v0.19.0@sha256:1140dc6931fa2db059f2eceeed08ce6e53038996dce56fa08b511c41872f6119"` | Controller image. |
...
| controller.securityContext | object | `{}` | SecurityContext for the controller container.G |
