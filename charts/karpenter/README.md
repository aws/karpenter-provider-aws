...
| controller.image.digest | string | `"sha256:fbe7aea25ad2f8f7627f18461f7c4ba197ccd45b94557ae446d6fcebad197775"` | SHA256 digest of the controller image. |
| controller.image.repository | string | `"public.ecr.aws/karpenter/controller"` | Repository path to the controller image. |
| controller.image.tag | string | `"1.7.2"` | Tag of the controller image. |
