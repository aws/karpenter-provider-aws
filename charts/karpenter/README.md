...
| controller.image.digest | string | `"sha256:1fec04fce962514eeedb11b315374b3e0202952dd8e4611789b497ae7e17ab3b"` | SHA256 digest of the controller image. |
| controller.image.repository | string | `"public.ecr.aws/karpenter/controller"` | Repository path to the controller image. |
| controller.image.tag | string | `"1.4.1"` | Tag of the controller image. |
