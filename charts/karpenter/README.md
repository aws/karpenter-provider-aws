...
| controller.image.digest | string | `"sha256:97abea5fc864f8fa6c4bbc0b9bae64b6fd4c258cb79cfa2356ec75892160ce1c"` | SHA256 digest of the controller image. |
| controller.image.repository | string | `"public.ecr.aws/karpenter/controller"` | Repository path to the controller image. |
| controller.image.tag | string | `"1.6.1"` | Tag of the controller image. |
