...
| controller.annotations | object | `{}` | Annotations for the controller |
...
| debugLevel | string | `"info"` | Global debug level |
...
| webhook.annotations | object | `{}` | Annotations for the webhook |
