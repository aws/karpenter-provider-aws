...
| controller.image.digest | string | `"sha256:fc54495b35dfeac6459ead173dd8452ca5d572d90e559f09536a494d2795abe6"` | SHA256 digest of the controller image. |
| controller.image.repository | string | `"public.ecr.aws/karpenter/controller"` | Repository path to the controller image. |
| controller.image.tag | string | `"1.0.1"` | Tag of the controller image. |
