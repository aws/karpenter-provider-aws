...
cosign verify public.ecr.aws/karpenter/karpenter:1.5.4 \
  ...
  --certificate-github-workflow-ref=refs/tags/v1.5.4 \
...
| controller.image.digest | string | `"sha256:2c704bc34c7604be1bc4f712d26d39093221c6912ac66b68c89de109a39dbf03"` | SHA256 digest of the controller image. |
| controller.image.repository | string | `"public.ecr.aws/karpenter/controller"` | Repository path to the controller image. |
| controller.image.tag | string | `"1.5.4"` | Tag of the controller image. |
