...
| controller.image.digest | string | `"sha256:3db4c69a249ce44c5a0df7a0057c8caa2391c0d98565d369785d149ccce70c8a"` | SHA256 digest of the controller image. |
| controller.image.repository | string | `"public.ecr.aws/karpenter/controller"` | Repository path to the controller image. |
| controller.image.tag | string | `"1.2.3"` | Tag of the controller image. |
