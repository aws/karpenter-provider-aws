...
| controller.image.digest | string | `"sha256:190a67b0209a1f08e4ba28aeefd04d8c5e7665be17c9cb0ccc4e2dee5fa11136"` | SHA256 digest of the controller image. |
| controller.image.repository | string | `"public.ecr.aws/karpenter/controller"` | Repository path to the controller image. |
| controller.image.tag | string | `"1.7.4"` | Tag of the controller image. |
