...
func init() {
	corev1.NormalizedLabels = lo.Assign(corev1.NormalizedLabels, map[string]string{"topology.ebs.csi.aws.com/zone": v1.LabelTopologyZone})
}
...
func (env *Environment) DefaultEC2NodeClass() *providerv1.EC2NodeClass {
