...
func TestResourceBasedNaming(t *testing.T) {
	RegisterFailHandler(Fail)
	BeforeSuite(func() {
		env = aws.NewEnvironment(t)
	})
	RunSpecs(t, "ResourceBasedNaming")
}
...
var _ = Describe("ResourceBasedNaming", func() {
	It("should provision a single node and connect it to the cluster", func() {
