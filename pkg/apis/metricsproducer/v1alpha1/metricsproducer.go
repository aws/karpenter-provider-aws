...
type QueueSpec struct {
	QueueProvider QueueProvider `json:"provider"`
	ID            string        `json:"id"`
}

// QueueProvider corresponds to an implementation of a queue
type QueueProvider string

// QueueProvider enum
const (
	AWSSQSQueueProvider QueueProvider = "AWSSQSQueueProvider"
)
