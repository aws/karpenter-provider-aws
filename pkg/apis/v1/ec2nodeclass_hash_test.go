...
var _ = Describe("Hash", func() {
	...
	DescribeTable(
		...
		Entry("ConnectionTracking TCPEstablishedTimeout", "9180024928670154732", v1.EC2NodeClass{Spec: v1.EC2NodeClassSpec{ConnectionTracking: &v1.ConnectionTracking{TCPEstablishedTimeout: &metav1.Duration{Duration: 300}}}}),
		Entry("ConnectionTracking UDPStreamTimeout", "5504804583946437300", v1.EC2NodeClass{Spec: v1.EC2NodeClassSpec{ConnectionTracking: &v1.ConnectionTracking{UDPStreamTimeout: &metav1.Duration{Duration: 120}}}}),
		Entry("ConnectionTracking UDPTimeout", "13336846917115801341", v1.EC2NodeClass{Spec: v1.EC2NodeClassSpec{ConnectionTracking: &v1.ConnectionTracking{UDPTimeout: &metav1.Duration{Duration: 45}}}}),
	...
	DescribeTable("should change hash when static fields are updated", func(changes v1.EC2NodeClass) {
		...
		Entry("ConnectionTracking TCPEstablishedTimeout", v1.EC2NodeClass{Spec: v1.EC2NodeClassSpec{ConnectionTracking: &v1.ConnectionTracking{TCPEstablishedTimeout: &metav1.Duration{Duration: 300}}}}),
		Entry("ConnectionTracking UDPStreamTimeout", v1.EC2NodeClass{Spec: v1.EC2NodeClassSpec{ConnectionTracking: &v1.ConnectionTracking{UDPStreamTimeout: &metav1.Duration{Duration: 120}}}}),
		Entry("ConnectionTracking UDPTimeout", v1.EC2NodeClass{Spec: v1.EC2NodeClassSpec{ConnectionTracking: &v1.ConnectionTracking{UDPTimeout: &metav1.Duration{Duration: 45}}}}),
	)
	// We create a separate test for updating blockDeviceMapping volumeSize, since resource.Quantity is a struct, and mergo.WithSliceDeepCopy
	// doesn't work well with unexported fields, like the ones that are present in resource.Quantity
