...
var _ = Describe("CEL/Validation", func() {
	...
	Context("Requirements", func() {
		It("should allow well known label exceptions", func() {
			...
			for label := range karpv1.WellKnownLabels.Difference(sets.New(karpv1.NodePoolLabelKey, karpv1.CapacityTypeLabelKey, v1.LabelInstanceTenancy, v1.LabelInstanceNitroEnclavesSupported)) {
	...
	Context("Labels", func() {
		It("should allow well known label exceptions", func() {
			oldNodePool := nodePool.DeepCopy()
			for label := range karpv1.WellKnownLabels.Difference(sets.New(karpv1.NodePoolLabelKey, v1.LabelInstanceNitroEnclavesSupported)) {
