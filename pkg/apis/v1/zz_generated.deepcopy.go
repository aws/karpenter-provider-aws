...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ParsedKubeletConfig) DeepCopyInto(out *ParsedKubeletConfig) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ParsedKubeletConfig.
func (in *ParsedKubeletConfig) DeepCopy() *ParsedKubeletConfig {
	if in == nil {
		return nil
	}
	out := new(ParsedKubeletConfig)
	in.DeepCopyInto(out)
	return out
}
