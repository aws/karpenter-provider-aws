...
func (in *EC2NodeClassSpec) DeepCopyInto(out *EC2NodeClassSpec) {
	*out = *in
	...
	if in.HandleRebalance != nil {
		in, out := &in.HandleRebalance, &out.HandleRebalance
		*out = new(bool)
		**out = **in
	}
	if in.RebalanceGracePeriod != nil {
		in, out := &in.RebalanceGracePeriod, &out.RebalanceGracePeriod
