...
func (in *EC2NodeClassSpec) DeepCopyInto(out *EC2NodeClassSpec) {
	*out = *in
	...
	if in.NetworkPerformanceOptions != nil {
		...
		*out = new(NetworkPerformanceOptions)
		(*in).DeepCopyInto(*out)
	}
	if in.Context != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NetworkPerformanceOptions) DeepCopyInto(out *NetworkPerformanceOptions) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NetworkPerformanceOptions.
func (in *NetworkPerformanceOptions) DeepCopy() *NetworkPerformanceOptions {
	if in == nil {
		return nil
	}
	out := new(NetworkPerformanceOptions)
