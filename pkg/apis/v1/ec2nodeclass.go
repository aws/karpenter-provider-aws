...
type AMISelectorTerm struct {
	...
	// This value is the name field, which is different from the name tag.
	// The placeholder {kubernetesVersion} can be used and will be replaced with the Kubernetes
	// version nodes are provisioned with (e.g. "my-ami-{kubernetesVersion}-*").
	// +optional
	Name string `json:"name,omitempty"`
	...
	// The placeholder {kubernetesVersion} can be used and will be replaced with the Kubernetes
	// version nodes are provisioned with (e.g. "/aws/service/eks/optimized-ami/{kubernetesVersion}/amazon-linux-2023/x86_64/standard/recommended/image_id").
	// +optional
