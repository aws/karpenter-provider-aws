...
func (in *EC2NodeClassStatus) convertTo(v1beta1enc *v1beta1.EC2NodeClassStatus) {
	...
	v1beta1enc.AMIs = lo.Map(in.AMIs, func(ami AMI, _ int) v1beta1.AMI {
		return v1beta1.AMI{
			ID:   ami.ID,
			Name: ami.Name,
			Requirements: lo.Map(ami.Requirements, func(req v1.NodeSelectorRequirement, _ int) corev1beta1.NodeSelectorRequirementWithMinValues {
				return corev1beta1.NodeSelectorRequirementWithMinValues{
...
func (in *EC2NodeClassStatus) convertFrom(v1beta1enc *v1beta1.EC2NodeClassStatus) {
	...
	in.AMIs = lo.Map(v1beta1enc.AMIs, func(ami v1beta1.AMI, _ int) AMI {
		return AMI{
			ID:   ami.ID,
			Name: ami.Name,
			Requirements: lo.Map(ami.Requirements, func(req corev1beta1.NodeSelectorRequirementWithMinValues, _ int) v1.NodeSelectorRequirement {
