...
func (in *Constraints) DeepCopyInto(out *Constraints) {
	*out = *in
	...
	in.KubeletArgs.DeepCopyInto(&out.KubeletArgs)
	if in.Provider != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *KubeletArgs) DeepCopyInto(out *KubeletArgs) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new KubeletArgs.
func (in *KubeletArgs) DeepCopy() *KubeletArgs {
	if in == nil {
		return nil
	}
	out := new(KubeletArgs)
