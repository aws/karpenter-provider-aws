...
func (in *ProvisionerSpec) DeepCopyInto(out *ProvisionerSpec) {
	*out = *in
	...
	out.Reallocation = in.Reallocation
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReallocationSpec) DeepCopyInto(out *ReallocationSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReallocationSpec.
func (in *ReallocationSpec) DeepCopy() *ReallocationSpec {
	if in == nil {
		return nil
	}
	out := new(ReallocationSpec)
	in.DeepCopyInto(out)
	return out
}
