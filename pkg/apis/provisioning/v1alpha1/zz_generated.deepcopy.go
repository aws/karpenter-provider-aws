...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *DeallocatorSpec) DeepCopyInto(out *DeallocatorSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new DeallocatorSpec.
func (in *DeallocatorSpec) DeepCopy() *DeallocatorSpec {
	if in == nil {
		return nil
	}
	out := new(DeallocatorSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ProvisionerSpec) DeepCopyInto(out *ProvisionerSpec) {
	*out = *in
	...
	out.Deallocator = in.Deallocator
}
