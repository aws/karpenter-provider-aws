...
func (in *AMISelectorTerm) DeepCopyInto(out *AMISelectorTerm) {
	*out = *in
	if in.EKSOptimized != nil {
		in, out := &in.EKSOptimized, &out.EKSOptimized
		*out = new(EKSOptimized)
		**out = **in
	}
	if in.Tags != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EKSOptimized) DeepCopyInto(out *EKSOptimized) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EKSOptimized.
func (in *EKSOptimized) DeepCopy() *EKSOptimized {
	if in == nil {
		return nil
	}
	out := new(EKSOptimized)
