...
func (in *EC2NodeClassSpec) DeepCopyInto(out *EC2NodeClassSpec) {
	*out = *in
	...
	if in.LicenseSelectorTerms != nil {
		in, out := &in.LicenseSelectorTerms, &out.LicenseSelectorTerms
		*out = make([]LicenseSelectorTerm, len(*in))
		copy(*out, *in)
	}
	if in.HostResourceGroupSelectorTerms != nil {
		in, out := &in.HostResourceGroupSelectorTerms, &out.HostResourceGroupSelectorTerms
		*out = make([]HostResourceGroupSelectorTerm, len(*in))
		copy(*out, *in)
	}
	if in.PlacementGroupSelectorTerms != nil {
		in, out := &in.PlacementGroupSelectorTerms, &out.PlacementGroupSelectorTerms
		*out = make([]PlacementGroupSelectorTerm, len(*in))
		copy(*out, *in)
	}
	if in.UserData != nil {
	...
	if in.OriginalLicenseSelector != nil {
		in, out := &in.OriginalLicenseSelector, &out.OriginalLicenseSelector
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.OriginalHostResourceGroupSelector != nil {
		in, out := &in.OriginalHostResourceGroupSelector, &out.OriginalHostResourceGroupSelector
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.OriginalPlacementGroupSelector != nil {
		in, out := &in.OriginalPlacementGroupSelector, &out.OriginalPlacementGroupSelector
		*out = make(map[string]string, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
...
func (in *EC2NodeClassStatus) DeepCopyInto(out *EC2NodeClassStatus) {
	*out = *in
	...
	if in.HostResourceGroup != nil {
		in, out := &in.HostResourceGroup, &out.HostResourceGroup
		*out = new(HostResourceGroup)
		**out = **in
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HostResourceGroup) DeepCopyInto(out *HostResourceGroup) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HostResourceGroup.
func (in *HostResourceGroup) DeepCopy() *HostResourceGroup {
	if in == nil {
		return nil
	}
	out := new(HostResourceGroup)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HostResourceGroupSelectorTerm) DeepCopyInto(out *HostResourceGroupSelectorTerm) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HostResourceGroupSelectorTerm.
func (in *HostResourceGroupSelectorTerm) DeepCopy() *HostResourceGroupSelectorTerm {
	if in == nil {
		return nil
	}
	out := new(HostResourceGroupSelectorTerm)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LicenseSelectorTerm) DeepCopyInto(out *LicenseSelectorTerm) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LicenseSelectorTerm.
func (in *LicenseSelectorTerm) DeepCopy() *LicenseSelectorTerm {
	if in == nil {
		return nil
	}
	out := new(LicenseSelectorTerm)
	in.DeepCopyInto(out)
	return out
}
