...
func (u Ubuntu2004) DefaultAMIs(version string) []DefaultAMIOutput {
...
func (u Ubuntu2004) UserData(kubeletConfig *corev1beta1.KubeletConfiguration, taints []v1.Taint, labels map[string]string, caBundle *string, _ []*cloudprovider.InstanceType, customUserData *string, _ *v1beta1.InstanceStorePolicy) bootstrap.Bootstrapper {
...
func (u Ubuntu2004) DefaultBlockDeviceMappings() []*v1beta1.BlockDeviceMapping {
...
func (u Ubuntu2004) EphemeralBlockDevice() *string {
