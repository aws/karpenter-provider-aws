...
func computeRequirements(
	...
	if len(capacityReservations) != 0 {
		...
		requirements.Add(scheduling.NewRequirement(v1.LabelInstanceMatchCriteria, corev1.NodeSelectorOpIn, lo.Map(capacityReservations, func(cr v1.CapacityReservation, _ int) string {
		...
		requirements.Add(scheduling.NewRequirement(v1.LabelInstanceMatchCriteria, corev1.NodeSelectorOpDoesNotExist))
