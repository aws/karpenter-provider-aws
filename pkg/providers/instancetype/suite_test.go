...
var _ = Describe("InstanceTypes", func() {
	...
	Context("Provider Cache", func() {
		It("changes to kubelet configuration fields should result in a different set of instances types", func() {
			...
			// The goal is to make sure that we don't have different configuration collapsing to the same cache key and have a fewer set of instancesTypes then expected
