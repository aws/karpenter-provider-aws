	...
	Context("NetworkInterfaceCompatibility", func() {
		DescribeTable("should validate network interface compatibility with instance types",
			...
			Entry("instance does not support with ENA",
				[]*v1.NetworkInterface{{NetworkCardIndex: 0, DeviceIndex: 0, InterfaceType: v1.InterfaceType(v1.InterfaceTypeInterface)}},
			...
			Entry("network card index exceeds available cards",
				[]*v1.NetworkInterface{{NetworkCardIndex: 1, DeviceIndex: 0, InterfaceType: v1.InterfaceType(v1.InterfaceTypeInterface)}},
				makeNetworkInfo(1, 4, nil),
				false,
			),
			Entry("device index exceeds maximum ENIs",
				[]*v1.NetworkInterface{{NetworkCardIndex: 0, DeviceIndex: 5, InterfaceType: v1.InterfaceType(v1.InterfaceTypeInterface)}},
				makeNetworkInfo(1, 4, nil),
				false,
			),
		)
