...
var initialPriceUpdateUS, _ = time.Parse(time.RFC3339, "2023-09-18T13:06:44Z")
var initialOnDemandPricesUS = map[string]map[string]float64{}

func init() {
	// us-east-1
	initialOnDemandPricesUS["us-east-1"] = map[string]float64{
		// a1 family
	...
	// us-gov-west-1
	initialOnDemandPricesUS["us-gov-west-1"] = map[string]float64{
		// c1 family
	...
	// us-gov-east-1
	initialOnDemandPricesUS["us-gov-east-1"] = map[string]float64{
		// c5 family
		"c5.12xlarge": 2.448000, "c5.18xlarge": 3.672000, "c5.24xlarge": 4.896000, "c5.2xlarge": 0.408000,
		"c5.4xlarge": 0.816000, "c5.9xlarge": 1.836000, "c5.large": 0.102000, "c5.metal": 4.896000,
		"c5.xlarge": 0.204000,
