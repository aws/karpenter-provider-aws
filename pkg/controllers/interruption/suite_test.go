...
var _ = BeforeSuite(func() {
	...
	controller = interruption.NewController(env.Client, cloudProvider, fakeClock, events.NewRecorder(&record.FakeRecorder{}), sqsProvider, aws.Config{}, unavailableOfferingsCache)
})
