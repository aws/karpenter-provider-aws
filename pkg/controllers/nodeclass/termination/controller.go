...
func (c *Controller) finalize(ctx context.Context, nodeClass *providerv1.EC2NodeClass) (reconcile.Result, error) {
	...
	controllerutil.RemoveFinalizer(nodeClass, providerv1.TerminationFinalizer)
