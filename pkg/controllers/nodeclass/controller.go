...
func NewController(
	...
	validation := NewValidationReconciler(kubeClient, cloudProvider, ec2api, amiResolver, instanceTypeProvider, launchTemplateProvider, validationCache, disableAWSValidation)
	return &Controller{
