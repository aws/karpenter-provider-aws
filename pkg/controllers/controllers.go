...
func NewControllers(
	...
	controllers := []controller.Controller{
		...
		nodeclass.NewController(clk, kubeClient, cloudProvider, recorder, subnetProvider, securityGroupProvider, amiProvider, instanceProfileProvider, launchTemplateProvider, capacityReservationProvider, ec2api, validationCache, amiResolver),
