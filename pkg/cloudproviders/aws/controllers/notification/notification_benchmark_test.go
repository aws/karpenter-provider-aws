...
type providerSet struct {
	...
	eventBridgeProvider *providers.EventBridgeProvider
}
...
func newProviders(ctx context.Context) providerSet {
	...
	sqsProvider := providers.NewSQSProvider(ctx, sqs.New(sess))
	eventBridgeProvider := providers.NewEventBridgeProvider(eventbridge.New(sess), sqsProvider)
	return providerSet{
...
func (p *providerSet) monitorMessagesProcessed(ctx context.Context, recorder *awsfake.EventRecorder, expectedProcessed int) <-chan struct{} {
