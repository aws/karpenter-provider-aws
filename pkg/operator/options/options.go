...
func (o *Options) AddFlags(fs *coreoptions.FlagSet) {
	...
	fs.BoolVarWithEnv(&o.DisableAuthValidation, "disable-auth-validation", "DISABLE_AUTH_VALIDATION", false, "If true, then disable auth validation for EC2NodeClasses.")
}
