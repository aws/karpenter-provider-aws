...
func (o *Options) AddFlags(fs *coreoptions.FlagSet) {
	...
	fs.BoolVarWithEnv(&o.DisableAuthValidation, "disable-auth-validation", "DISABLE_AUTH_VALIDATION", false, "If true, then disable dry run checks for auth validation of EC2NodeClasses.")
}
