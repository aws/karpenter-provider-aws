...
func (o *Options) AddFlags(fs *coreoptions.FlagSet) {
	...
	fs.StringVar(&o.FeatureGates.inputStr, "aws-feature-gates", env.WithDefaultString("AWS_FEATURE_GATES", "NodeClassCEL=false,DRA=false"), "Optional AWS-specific features can be enabled / disabled using feature gates. Current options are: NodeClassCEL, DRA.")
}
