...
func (o *Options) AddFlags(fs *coreoptions.FlagSet) {
	...
	fs.BoolVarWithEnv(&o.IsEKSControlPlane, "is-eks-control-plane", "EKS_CONTROL_PLANE", true, "If true, then assume running on EKS control plane and attempt to discover Kubernetes version via DescribeCluster API ")
