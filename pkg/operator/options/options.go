...
func (o *Options) AddFlags(fs *coreoptions.FlagSet) {
	...
	fs.StringVar(&o.PricingRegionOverride, "pricing-region-override", env.WithDefaultString("PRICING_REGION_OVERRIDE", ""), "Override the AWS region for Pricing API requests. If not specified, defaults to: eu-central-1 (eu-* clusters), ap-south-1 (ap-* clusters), cn-northwest-1 (cn-* clusters), us-east-1 (all others)")
}
