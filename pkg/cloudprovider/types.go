...
type InstanceType interface {
	...
	// Price is a metric that is used by Karpenter's scheduler to prefer some instances over others.  This can be an
	// actual monetary price per hour for the instance type, or just a weighting where lower 'prices' are preferred.
	Price() float64
}
