...
type AWS struct {
	...
	// Amazonlinux specific provider configuration
	// +optional
	Amazonlinux *AmazonlinuxOptions `json:"amazonlinux,omitempty"`
	// Bottlerocket specific provider configuration
	// +optional
	Bottlerocket *BottlerocketOptions `json:"bottlerocket,omitempty"`
	// Ubuntu specific provider configuration
	// +optional
	Ubuntu *UbuntuOptions `json:"ubuntu,omitempty"`
	// Generic provider configuration
	// +optional
	Generic *GenericOptions `json:"generic,omitempty"`
	// Predefined provider configuration using an already existing LaunchTemplate
	// +optional
	Predefined *PredefinedOptions `json:"predefined,omitempty"`
}
