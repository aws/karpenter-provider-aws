...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConfigMapUserDataSource) DeepCopyInto(out *ConfigMapUserDataSource) {
	*out = *in
	if in.Name != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConfigMapUserDataSource.
func (in *ConfigMapUserDataSource) DeepCopy() *ConfigMapUserDataSource {
	if in == nil {
		return nil
	}
	out := new(ConfigMapUserDataSource)
	in.DeepCopyInto(out)
	return out
}
