...
func (p *InstanceTypeProvider) createOfferings(ctx context.Context, nodeTemplate *v1alpha1.AWSNodeTemplate, instanceType *ec2.InstanceTypeInfo, zones sets.String) []cloudprovider.Offering {
