...
instanceTypeTestData() {
  ...
  go run hack/code/instancetype_testdata_gen/main.go --out-file ${GENERATED_FILE} \
    --instance-types t3.large,m5.large,m5.xlarge,g5.12xlarge,g4dn.8xlarge,c6g.large,inf2.xlarge,inf2.24xlarge,trn1.2xlarge,m5.metal,m6idn.32xlarge,t4g.small,t4g.xlarge,t4g.medium,m7i-flex.large,p5.48xlarge,g6.12xlarge
