...
func main() {
	...
	genStart := "[comment]: <> (the content below is generated from hack/docs/compataiblitymetrix/main.go)"
	genEnd := "[comment]: <> (end docs generated content from hack/docs/compataiblitymetrix/main.go)"
