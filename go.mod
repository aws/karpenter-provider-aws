...
replace sigs.k8s.io/karpenter => github.com/engedaam/karpenter-core v0.0.0-20250725181414-e5d8430c7b25
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/fis v1.33.5
	...
	sigs.k8s.io/karpenter v1.6.1-0.20250724204428-b3214cd3ead3
