...
require (
	...
	sigs.k8s.io/karpenter v0.37.4-0.20240917214243-cb36671f459f
	sigs.k8s.io/yaml v1.4.0
)

replace knative.dev/pkg => github.com/jonathan-innis/knative-pkg v0.0.0-20240923062126-cf5f7be26c4b

replace sigs.k8s.io/karpenter => github.com/jonathan-innis/karpenter v0.0.4-0.20240923062747-0922f28fae77
