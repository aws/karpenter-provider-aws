...
Both the `karpenter.sh/do-not-consolidate` and the `karpenter.sh/do-not-evict` annotations were [deprecated in `v0.32.0`]({{<ref "./v1beta1-migration/#annotations-labels-and-status-conditions">}}).
...
Support for setting the Zap logging config was [deprecated in `v0.32.0`]({{<ref "./v1beta1-migration#logging-configuration-is-no-longer-dynamic" >}}) and has been been removed in `v1.0.0`.
