...
See the [Compatibility Matrix in the Upgrade Guide]({{< ref "./upgrade/upgrade-guide#compatibility-matrix" >}}) to view the supported Kubernetes versions per Karpenter released version.
