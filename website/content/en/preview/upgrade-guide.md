...
* Do not upgrade to this version unless you are on Kubernetes > v1.21. Karpenter no longer supports Kubernetes v1.20, but now supports Kubernetes v1.25. This change is due to the v1 pdb API, which was introduced in 1.20 and subsequent removal of the v1beta1 API in v1.25.
