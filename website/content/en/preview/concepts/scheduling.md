...
| karpenter.k8s.aws/instance-capability-block-storage-optimized  | true         | [AWS Specific] Instance types with block storage optimized capability (`b` instances)                                                                                      |
| karpenter.k8s.aws/instance-capability-extra-storage            | true         | [AWS Specific] Instance types with extra storage capability (`e` instances)                                                                                      |
| karpenter.k8s.aws/instance-capability-flex                     | true         | [AWS Specific] Instance types with flex capability (`-flex` instances)                                                                                      |
| karpenter.k8s.aws/instance-capability-high-performance         | true         | [AWS Specific] Instance types with high performance capability (`z` instances)                                                                                      |
| karpenter.k8s.aws/instance-capability-instance-store-volume    | true         | [AWS Specific] Instance types with instance store volumes capability (`d` instances)                                                                                      |
| karpenter.k8s.aws/instance-capability-network-optimized        | true         | [AWS Specific] Instance types with network optimized capability (`n` instances)                                                                                      |
| karpenter.k8s.aws/instance-qualcomm-inference                  | true         | [AWS Specific] Instance types with Qualcomm inference accelerator capability (`q` instances)                                                                                      |
