...
| karpenter.k8s.aws/instance-performance-mode                    | standard    | [AWS Specific] Instance types of similar performance mode. Either `standard`, [`burstable`](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/burstable-performance-instances.html) or [`flex`](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/general-purpose-instances.html#general-purpose-performance)                                                              |
