...
For Spot instances, you should specify `karpenter.sh/capacity-type: spot` in your requirements. For example, the below spec uses Spot instances for all provisioned nodes and enforces `minValues` for the keys where it is defined:
