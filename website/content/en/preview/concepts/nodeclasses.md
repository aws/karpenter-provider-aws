...
| ValidationSucceeded  | EC2NodeClass CRD validation succeeded.                                                                                                                                                                                            |
| PlacementGroupReady  | Placement groups referenced by the EC2NodeClass are discovered.                                                                                                                                                                   |
| CapacityReservationsReady | Capacity reservations referenced by the EC2NodeClass are discovered when that feature is enabled.                                                                                                                          |
