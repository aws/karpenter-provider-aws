...
spec:
  ...
  # Optional, specifies directories that should not be mounted onto local storage
  disabledMounts:
...
The `disabledMounts` field specifies directories that should not be mounted onto local storage. By default, all mounts are enabled.
