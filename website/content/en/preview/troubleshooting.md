...
To avoid the error messages, set the AWS_ISOLATED_VPC environment variable (or the `--aws-isolated-vpc` option) to true when you configure Karpenter to disable pricing lookups.
