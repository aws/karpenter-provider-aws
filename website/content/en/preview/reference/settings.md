...
| MIN_SUBNET_AVAILABLE_IPS | \-\-min-subnet-available-ips | Minimum available IPs required in a subnet before launching nodes in that zone. Zones where all subnets are below this threshold will be skipped. Set to 0 to disable filtering (default). Recommended value: 10-50. (default = 0)|
