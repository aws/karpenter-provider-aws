...
The AllowSSMReadActions Sid allows the Karpenter controller to list SSM parameters (`ssm:GetParameter`) from the current region for SSM parameters generated by ASW services.
