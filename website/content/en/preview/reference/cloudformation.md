...
Karpenter supports AWS Application Recovery Controller Zonal Shift, that you can utilize as described in the [Zonal Shift]({{< relref "../concepts/scheduling/#zonalshift">}}) section of the Scheduling page.
