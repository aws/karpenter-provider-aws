...
7. Set environment variables for first upgrading to v1.0.2
...
8. Update your existing policy using the following to the v1.0.2 controller policy:
...
9. Apply the v1.0.2 Custom Resource Definitions (CRDs):
