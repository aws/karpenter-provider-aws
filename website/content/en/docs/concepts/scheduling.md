...
| karpenter.k8s.aws/instance-capability-nested-virtualization    | true                 | [AWS Specific] Instance type supports nested virtualization per `ProcessorInfo.SupportedFeatures` from `DescribeInstanceTypes`                                                                                                              |
