...
| karpenter.k8s.aws/instance-match-criteria                      | targeted             | [AWS Specific] How instances match the capacity reservation. Can be `open` or `targeted`. Only present on reserved nodes.                                                                                                                |
