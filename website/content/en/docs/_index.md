...
---
Karpenter is an open-source autoscaling project built for Kubernetes.
...
As an application developers, you can make specific requests for capacity and features you want from the nodes running your pods.
