...
```shell
kubectl apply -f https://raw.githubusercontent.com/aws/karpenter/v0.31.1/pkg/apis/crds/karpenter.sh_provisioners.yaml
kubectl apply -f https://raw.githubusercontent.com/aws/karpenter/v0.31.1/pkg/apis/crds/karpenter.sh_machines.yaml
kubectl apply -f https://raw.githubusercontent.com/aws/karpenter/v0.31.1/pkg/apis/crds/karpenter.k8s.aws_awsnodetemplates.yaml
```
...
* Karpenter CRD raw YAML URLs have migrated from `https://raw.githubusercontent.com/aws/karpenter/v0.31.1/charts/karpenter/crds/...` to `https://raw.githubusercontent.com/aws/karpenter/v0.31.1/pkg/apis/crds/...`. If you reference static Karpenter CRDs or rely on `kubectl replace -f` to apply these CRDs from their remote location, you will need to migrate to the new location.
