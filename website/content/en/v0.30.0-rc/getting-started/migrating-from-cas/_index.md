...
```bash
export KARPENTER_VERSION=v0.30.0-rc.0
```
...
You can refer to some of the [example provisioners](https://github.com/aws/karpenter/tree/v0.30.0-rc.0/examples/provisioner) for specific needs.
