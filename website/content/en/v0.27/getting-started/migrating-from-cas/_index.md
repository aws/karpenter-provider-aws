...
```bash
export KARPENTER_VERSION=v0.27.6
```
...
You can refer to some of the [example provisioners](https://github.com/aws/karpenter/tree/v0.27.6/examples/provisioner) for specific needs.
