...
Full Changelog:
* https://github.com/aws/karpenter-provider-aws/releases/tag/v1.5.3
* https://github.com/kubernetes-sigs/karpenter/releases/tag/v1.5.3
...
{{% alert title="Warning" color="warning" %}}
Karpenter `0.32.0` introduces v1beta1 APIs, including _significant_ changes to the API and installation procedures for the Karpenter controllers. **Do not** upgrade to `0.32.0`+ without referencing the [v1beta1 Migration Upgrade Procedure]({{<ref "./v1beta1-migration#upgrade-procedure" >}}).
