...
```bash
export KARPENTER_VERSION="1.8.7"
```
...
We need to create a default NodePool so Karpenter knows what types of nodes we want for unscheduled workloads. You can refer to some of the [example NodePool](https://github.com/aws/karpenter/tree/v1.8.7/examples/v1) for specific needs.
